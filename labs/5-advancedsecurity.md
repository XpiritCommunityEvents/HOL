...
## 5.2 Code Scanning
### 5.2.1 Code Scanning: What is it?
...
### 5.2.2 Enabling the Code Scanning functionality
...
### 5.2.3 Analyzing Code Scanning outcomes
...
## 5.3 Secret Scanning
### 5.3.1 Secret Scanning: What is it?
...
### 5.3.2 Enabling Secret Scanning functionality
...
### 5.3.3 Managing Secret Scanning alerts
...
#### 5.3.4 Secret Scanning: Alert notifications
...
#### 5.3.5 Secret Scanning: Securing compromised secrets
